...
2단계 new_id에서 알파벳 소문자, 숫자, 빼기(-), 밑줄(_), 마침표(.)
    를 제외한 모든 문자를 제거합니다.
...
def solution(new_id):
    ...
    # 조건 2. letter 확인해서 문자나 숫자면 혹은 "-_." 면 문자열에 조인
    new_id = "".join(letter for letter in new_id if letter.isalnum() or letter in "-_.")
